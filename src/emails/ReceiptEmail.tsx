    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={message}>
          <Img
            src={`${BASE_URL}/email-logo.png`} // production
            //src={"https://i.ibb.co/zRQ6qcJ/email-logo.png"} // development
            width="120"
            height="80"
            alt="Nike"
            style={{ margin: "auto" }}
          ...
          <Text style={{ ...global.text, marginTop: 24 }}>
            Your order is on its way. Your payment has been processed and your
