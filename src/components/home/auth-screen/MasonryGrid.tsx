...
const MasonryGrid = () => {
    // generic type <number | null>(null)
    const [hoverIndex, setHoverIndex] = useState<number | null>(null);
	// if you run the mouse over mousePosition, typeScript know the types are { x: number; y: number }, 
    // To be consistent add the generic type <{ x: number; y: number }> with the default value { x: 0, y: 0 }
